 ...
 * It computes a histogram for integer data within specified bins, normalizing
 * the input data to fit within the specified range and computing the histogram
 * with the given number of bins.
 * 
 * Please read hist_int.m for more information, usage and limitations.
 * 
